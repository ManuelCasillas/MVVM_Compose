...
fun Navigation(navController: NavHostController, logout: () -> Unit) {
    ...
    SharedTransitionLayout {
        NavHost(
            ...
            startDestination = MainRoutes.CharacterScreen,
        ) {


                composable<MainRoutes.CharacterScreen> {
                    CharactersRoot(animatedVisibilityScope = this, onCharacterClickNavigation = { character, characterID ->
                ...
                composable<MainRoutes.CharacterDetailScreen>(
                    ...
                    CharacterDetailsRoot(args = args, animatedVisibilityScope = this)
                }
